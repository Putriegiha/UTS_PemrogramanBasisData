                ...
                <div class="card-body">
                    ...
                    <form action="{{route('satuan.update',$satuan->idsatuan)}}" method="POST">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="inputnama_satuan" name="nama_satuan" value="{{old('nama_satuan',$satuan->nama_satuan)}}" placeholder="cont. Kg atau Liter atau Pcs">
                        </div>
                        <br>
                        <div class="col-12">
                            <label for="inputstatus" class="form-label">Status Satuan</label>
                            <input type="text" class="form-control" id="inputstatus" name="status" value="{{old('status',$satuan->STATUS)}}" placeholder="cont. (1 = aktif) atau (0 = no aktif)">
                        </div>
                        <br>
