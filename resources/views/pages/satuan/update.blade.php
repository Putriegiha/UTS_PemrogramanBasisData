                ...
                <div class="card-body">
                    ...
                    <form action="{{route('satuan.update',$satuan->idsatuan)}}" method="POST">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="inputNanme4" name="nama_satuan" value="{{old('nama_satuan',$satuan->nama_satuan)}}">
                        </div>
                        <br>
                        <div class="col-12">
                            <label for="inputNanme4" class="form-label">Status Satuan</label>
                            <input type="text" class="form-control" id="inputNanme4" name="status" value="{{old('status',$satuan->status)}}">
                        </div>
                        <br>
